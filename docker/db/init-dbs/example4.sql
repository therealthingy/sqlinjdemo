...
DROP SCHEMA IF EXISTS `example4-db`;

-- !40100 DEFAULT CHARACTER SET latin1
CREATE SCHEMA IF NOT EXISTS `example4-db` DEFAULT CHARACTER SET utf8 ;
USE `example4-db`;
...
INSERT INTO `users` 
VALUES 
  (1,'jared','jared','Jared','Mooring','jared@test.com'),
  (2,'allan','allan','Allan','Shone','allan@test.com');
